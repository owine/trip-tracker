...
def _fold(line: str) -> str:
    ...
    while remaining:
        ...
        # `remaining` always starts at a valid UTF-8 boundary (we slice at
        # boundaries below), so this loop terminates well before cut=0.
        cut = budget
        while cut > 0:
            try:
...
async def regenerate_ics_token(
    ...
    # both shapes without the regex/replace gymnastics that triggered review
    # concerns.
